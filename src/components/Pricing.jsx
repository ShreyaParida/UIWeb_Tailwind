...
import { features, pricingOptions } from "../../virtualr-main/src/constants";
const Pricing = () => {
  return (
    <div id="pc" className="container mx-auto px-4">
        ...
        {pricingOptions.map((option, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3 p-2">
            <div className="p-10 border border-neutral-700 rounded-xl">
              ...
              <p className="mb-8">
                <span className="text-5xl mt-6 me-2">{option.price}</span>
